...
st.sidebar.markdown('<div style="padding:16px 24px;font-family:\'DM Mono\',monospace;font-size:10px;color:#3A3A36;letter-spacing:0.1em">v1.0 / 2026</div>', unsafe_allow_html=True)
